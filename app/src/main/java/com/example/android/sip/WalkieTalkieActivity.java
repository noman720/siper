...
public class WalkieTalkieActivity extends Activity implements View.OnTouchListener {
    ...
    public static String TAG = "WalkieTalkieActivity";
...
//        initializeManager();
    ...
    public void onResume(){
        ...
        registerPhoneAccount(getApplicationContext());
    }
    ...
    public void initializeLocalProfile() {
        ...
        Log.i(TAG, "user: "+username + " | domain: "+domain+" | password: "+password);
        ...
        try {
            ...
            Log.i(TAG, "Opened sip profile: "+me.getUriString());
            Log.i(TAG, "isOpened: "+manager.isOpened(me.getUriString()));
...
//        telecomManager.clearAccounts();
        ...
        telecomManager.registerPhoneAccount(PhoneAccount.builder(
                ...
                .setShortDescription("A personal sip dialer @ Noman")
